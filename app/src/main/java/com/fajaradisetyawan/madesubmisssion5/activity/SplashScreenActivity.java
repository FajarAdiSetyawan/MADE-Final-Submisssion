...
import com.fajaradisetyawan.madesubmisssion5.adapter.ProgressBarAnimation;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void startAnimasi(){
        final ValueAnimator animator = ValueAnimator.ofFloat(0f, 1f).setDuration(7000); //5000ms= 5s
